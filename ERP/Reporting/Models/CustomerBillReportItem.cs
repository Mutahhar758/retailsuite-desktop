...
namespace ERP.Reporting.Models
{
    ...
    public class CustomerBillLineItem
    {
        ...
        public string FormattedAddLess => AddLess != 0 ? "Rs. " + AddLess.ToString("#,##0.00") : "-";
        public string FormattedAmount => "Rs. " + Amount.ToString("#,##0.00");
    }
    ...
    public class CustomerBillSummary
    {
        ...
        public string FormattedPreviousBalance => "Rs. " + PreviousBalance.ToString("#,##0.00");
        public string FormattedCurrentBillTotal => "Rs. " + CurrentBillTotal.ToString("#,##0.00");
        public string FormattedGrossTotal => "Rs. " + GrossTotal.ToString("#,##0.00");
        public string FormattedPaymentsReceived => "Rs. " + PaymentsReceived.ToString("#,##0.00");
        public string FormattedNetBalance => "Rs. " + NetBalance.ToString("#,##0.00");
    }
